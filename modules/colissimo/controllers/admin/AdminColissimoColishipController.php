    ...
    public function processExportCsv()
    {
        ...
        foreach ($results as $result) {
            ...
            $lineExp = array(
                ...
                'dest_mobile'      => $deliveryAddr->phone_mobile,
            ...
            if (ColissimoTools::needCN23($merchantAddress->countryCode, $isoCustomerAddress, $customerAddr->postcode)) {
                ...
                foreach ($products as $product) {
                    ...
                    $productWeight = (float) $product['product_weight'] ? ColissimoTools::weightInKG($product['product_weight']) : 0.05;
                    $lineCN23 = array(
                        'cn_code'           => 'CN2',
                        'cn_print'          => 'O',
